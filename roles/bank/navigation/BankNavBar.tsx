...
const bankNav = [
  { id: 'home',    label: '资本星云',   icon: TrendingUp,  color: '#00D6C2', path: '/bank/home' },
  { id: 'finance', label: '资本审批',   icon: DollarSign,  color: '#18FF74', path: '/bank/finance' },
  { id: 'expert',  label: '资本智库',   icon: Briefcase,   color: '#FF7A9C', path: '/bank/expert' },
  { id: 'trade',   label: '资本数据',   icon: BarChart2,   color: '#FFE600', path: '/bank/trade' },
  { id: 'profile', label: '资本宇宙',   icon: User,        color: '#A5ACBA', path: '/bank/profile' },
];
