...
const buyerNav = [
  { id: 'home',    label: '购市星云',   icon: Grid,        color: '#FFE600', path: '/buyer/home' },
  { id: 'finance', label: '购市分期',   icon: CreditCard,  color: '#00D6C2', path: '/buyer/finance' },
  { id: 'expert',  label: '购市学堂',   icon: BookOpen,    color: '#FF7A9C', path: '/buyer/expert' },
  { id: 'trade',   label: '购市市场',   icon: ShoppingBag, color: '#18FF74', path: '/buyer/trade' },
  { id: 'profile', label: '购市宇宙',   icon: User,        color: '#A5ACBA', path: '/buyer/profile' },
];
