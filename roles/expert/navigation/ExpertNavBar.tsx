...
const expertNav = [
  { id: 'home',    label: '知识星系',   icon: Star,         color: '#FF7A9C', path: '/expert/home' },
  { id: 'finance', label: '知识收益',   icon: DollarSign,   color: '#18FF74', path: '/expert/finance' },
  { id: 'expert',  label: '知识管理',   icon: Edit3,        color: '#00D6C2', path: '/expert/expert' },
  { id: 'trade',   label: '知识市场',   icon: ShoppingCart, color: '#FFE600', path: '/expert/trade' },
  { id: 'profile', label: '知识宇宙',   icon: User,         color: '#A5ACBA', path: '/expert/profile' },
];
