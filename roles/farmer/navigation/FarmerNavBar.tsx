...
const farmerNav = [
  ...
  { id: 'expert',  label: '专家',   icon: MessageCircle, color: '#FF7A9C', path: '/farmer/expert' },
  { id: 'trade',   label: '商品',   icon: Package,      color: '#FFE600', path: '/farmer/trade' },
  { id: 'profile', label: '我的',   icon: User,         color: '#A5ACBA', path: '/farmer/profile' },
];
