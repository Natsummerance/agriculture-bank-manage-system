...
const farmerNav = [
  { id: 'home',    label: '田心星云',   icon: Home,         color: '#18FF74', path: '/farmer/home' },
  { id: 'finance', label: '田心金融',   icon: DollarSign,   color: '#00D6C2', path: '/farmer/finance' },
  { id: 'expert',  label: '田心学堂',   icon: Users,        color: '#FF7A9C', path: '/farmer/expert' },
  { id: 'trade',   label: '田心市场',   icon: ShoppingCart, color: '#FFE600', path: '/farmer/trade' },
  { id: 'profile', label: '田心宇宙',   icon: User,         color: '#A5ACBA', path: '/farmer/profile' },
];
...
export default function FarmerNavBar() {
  ...
  useEffect(() => {
    ...
    const activeItem = farmerNav.find(item => currentPath.includes(item.id));
    if (activeItem) {
