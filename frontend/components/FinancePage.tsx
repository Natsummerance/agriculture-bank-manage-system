          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1">
                  <h3 className="text-white mb-1">贷款申请</h3>
                  <p className="text-white/60 text-sm">在线快速申请贷款</p>
                </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1">
                  <h3 className="text-white mb-1">联合贷款</h3>
                  <p className="text-white/60 text-sm">智能匹配联合贷款</p>
                </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left flex-1">
                  <h3 className="text-white mb-1">贷款审批</h3>
                  <p className="text-white/60 text-sm">银行审批管理</p>
                </div>
